...
<body style="background-color: #ffffe0;">
    <header>
        ...
        <div class="welcome">
            <h1>The Flower Shop That You Will Only Need</h1>
        </div>
    </header>
    <div>
        <img id= "c1" src="flower.svg" width="200" height="200">
        <img id= "c2" src="fle.svg" width="200" height="200">
        <img id= "c2" src="saku.svg" width="200" height="200">
        <img id= "c2" src="fla.svg" width="200" height="200">
    </div>
    <div>
